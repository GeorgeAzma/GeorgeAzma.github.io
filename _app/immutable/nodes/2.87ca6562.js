import{s as J,n as R,o as on,b as an,r as sn,f as ln,t as cn}from"../chunks/scheduler.b108d059.js";import{S as Q,i as nn,g as T,s as S,h as E,y as U,c as k,j as q,f as A,k as v,a as D,r as W,m as fn,u as M,n as dn,v as V,x as m,z as j,d as H,t as I,w as N}from"../chunks/index.f5626e03.js";function vn(d){let r,s=`<a href="https://shadertoy.com/user/Peace" target="_blank" class="svelte-11ed129"><img class="nav-icon svelte-11ed129" src="shadertoy.webp" alt="Shadertoy Icon" width="38" height="38"/>
		...
		LinkedIn</a>`,f,t;return{c(){r=T("nav"),r.innerHTML=s,f=S(),t=T("div"),this.h()},l(e){r=E(e,"NAV",{id:!0,class:!0,"data-svelte-h":!0}),U(r)!=="svelte-w5m299"&&(r.innerHTML=s),f=k(e),t=E(e,"DIV",{}),q(t).forEach(A),this.h()},h(){v(r,"id","navbar"),v(r,"class","svelte-11ed129")},m(e,i){D(e,r,i),D(e,f,i),D(e,t,i)},p:R,i:R,o:R,d(e){e&&(A(r),A(f),A(t))}}}class un extends Q{constructor(r){super(),nn(this,r,null,vn,J,{})}}function mn(d){let r;return{c(){r=T("canvas"),this.h()},l(s){r=E(s,"CANVAS",{id:!0,class:!0}),q(r).forEach(A),this.h()},h(){v(r,"id","background-shader"),v(r,"class","svelte-cx4n7w")},m(s,f){D(s,r,f),d[3](r)},p:R,i:R,o:R,d(s){s&&A(r),d[3](null)}}}function hn(d,r,s){let{frag:f=""}=r,{vert:t=""}=r,e,i=null,n=null,_=performance.now(),u=performance.now(),b=null,g=!1;function $(){const a=e.getBoundingClientRect();return a.top>=0&&a.left>=0&&a.bottom<=window.innerHeight&&a.right<=window.innerWidth}function h(){if(s(0,e.width=window.innerWidth,e),s(0,e.height=window.innerHeight,e),n&&i){const a=n.getUniformLocation(i,"resolution");n.uniform2f(a,e.width,e.height),n.viewport(0,0,e.width,e.height)}}on(()=>{if(n=e.getContext("webgl2"),!n){console.error("WebGL is not supported in this browser.");return}return _=performance.now(),window.addEventListener("resize",h),L(t,f),()=>{window.removeEventListener("resize",h)}});function L(a,l){if(g=!1,l||(l="precision mediump float;void main() {gl_FragColor=vec4(1);}"),a||(a="attribute vec4 a_position;void main() {gl_Position = a_position;}"),!!n){if($()){const p=n.createShader(n.FRAGMENT_SHADER);if(!p){alert("Could not create fragment shader");return}if(n.shaderSource(p,l),n.compileShader(p),!n.getShaderParameter(p,n.COMPILE_STATUS)){const z=n.getShaderInfoLog(p);console.error("Fragment shader compilation error:",z)}const o=n.createShader(n.VERTEX_SHADER);if(!o){alert("Could not create vertex shader");return}if(n.shaderSource(o,a),n.compileShader(o),!n.getShaderParameter(o,n.COMPILE_STATUS)){const z=n.getShaderInfoLog(o);console.error("Vertex shader compilation error:",z)}if(i&&(n.deleteProgram(i),i=null),i=n.createProgram(),!i){alert("Could not create shader program");return}n.attachShader(i,p),n.attachShader(i,o),n.linkProgram(i),n.deleteShader(p),n.deleteShader(o),b===null?(b=n.createBuffer(),n.bindBuffer(n.ARRAY_BUFFER,b),n.bufferData(n.ARRAY_BUFFER,new Float32Array([-1,-1,1,-1,-1,1,1,1]),n.STATIC_DRAW)):n.bindBuffer(n.ARRAY_BUFFER,b),n.useProgram(i);const y=n.getAttribLocation(i,"a_position");n.enableVertexAttribArray(y),n.vertexAttribPointer(y,2,n.FLOAT,!1,0,0),g=!0}h(),w()}}function w(){if(!(e&&n))return;let a=performance.now();if(!$()){requestAnimationFrame(w);const p=a-u;_+=p,u=a;return}g||L(t,f),n.clearColor(0,0,0,1),n.clear(n.COLOR_BUFFER_BIT),n.useProgram(i),n.drawArrays(n.TRIANGLE_STRIP,0,4);const l=n.getUniformLocation(i,"time");l&&n.uniform1f(l,(a-_)/1e3),u=a,requestAnimationFrame(w)}function F(a){an[a?"unshift":"push"](()=>{e=a,s(0,e)})}return d.$$set=a=>{"frag"in a&&s(1,f=a.frag),"vert"in a&&s(2,t=a.vert)},d.$$.update=()=>{d.$$.dirty&6&&L(t,f)},[e,f,t,F]}class P extends Q{constructor(r){super(),nn(this,r,hn,mn,J,{frag:1,vert:2})}}const pn=`precision lowp float;\r
\r
...
\r
    gl_FragColor = vec4(col, 1);\r
}`;function yn(d){let r,s,f,t,e,i,n,_,u,b,g,$,h,L,w,F="I'm Lumiey, graphics developer and software engineer.",a,l,p,o,y="(Copied)",z,B,en='<svg viewBox="-4.5 0 20 20" stroke="#ffffffcc" stroke-width="0.6" fill="#ffffffaa" class="svelte-m6xsfi"><path transform="translate(-331.000000, -6519.000000)" d="M338.61,6539 L340,6537.594 L331.739,6528.987 L332.62,6528.069 L332.615,6528.074 L339.955,6520.427 L338.586,6519 C336.557,6521.113 330.893,6527.014 329,6528.987 C330.406,6530.453 329.035,6529.024 338.61,6539" class="svelte-m6xsfi"></path></svg>',Y,O,rn='<svg viewBox="-4.5 0 20 20" stroke="#ffffffcc" stroke-width="0.6" fill="#ffffffaa" class="svelte-m6xsfi"><path transform="scale(-1, 1) translate(-341.000000, -6519.000000)" d="M338.61,6539 L340,6537.594 L331.739,6528.987 L332.62,6528.069 L332.615,6528.074 L339.955,6520.427 L338.586,6519 C336.557,6521.113 330.893,6527.014 329,6528.987 C330.406,6530.453 329.035,6529.024 338.61,6539" class="svelte-m6xsfi"></path></svg>',G,Z,tn;return s=new un({}),e=new P({props:{frag:pn}}),n=new P({props:{frag:gn}}),u=new P({props:{frag:wn}}),g=new P({props:{frag:xn}}),h=new P({props:{frag:_n}}),{c(){r=T("div"),W(s.$$.fragment),f=S(),t=T("div"),W(e.$$.fragment),i=S(),W(n.$$.fragment),_=S(),W(u.$$.fragment),b=S(),W(g.$$.fragment),$=S(),W(h.$$.fragment),L=S(),w=T("h1"),w.textContent=F,a=S(),l=T("button"),p=fn(K),o=T("span"),o.textContent=y,z=S(),B=T("button"),B.innerHTML=en,Y=S(),O=T("button"),O.innerHTML=rn,this.h()},l(c){r=E(c,"DIV",{id:!0,class:!0});var x=q(r);M(s.$$.fragment,x),f=k(x),t=E(x,"DIV",{id:!0,class:!0});var C=q(t);M(e.$$.fragment,C),i=k(C),M(n.$$.fragment,C),_=k(C),M(u.$$.fragment,C),b=k(C),M(g.$$.fragment,C),$=k(C),M(h.$$.fragment,C),C.forEach(A),L=k(x),w=E(x,"H1",{class:!0,"data-svelte-h":!0}),U(w)!=="svelte-12vckjm"&&(w.textContent=F),a=k(x),l=E(x,"BUTTON",{id:!0,"aria-label":!0,class:!0});var X=q(l);p=dn(X,K),o=E(X,"SPAN",{class:!0,"data-svelte-h":!0}),U(o)!=="svelte-nvhv7g"&&(o.textContent=y),X.forEach(A),z=k(x),B=E(x,"BUTTON",{class:!0,"aria-label":!0,"data-svelte-h":!0}),U(B)!=="svelte-1eth16w"&&(B.innerHTML=en),Y=k(x),O=E(x,"BUTTON",{class:!0,"aria-label":!0,"data-svelte-h":!0}),U(O)!=="svelte-3l2q6y"&&(O.innerHTML=rn),x.forEach(A),this.h()},h(){v(t,"id","shaders"),v(t,"class","svelte-m6xsfi"),v(w,"class","main-text svelte-m6xsfi"),v(o,"class","hidden svelte-m6xsfi"),v(l,"id","contact-info"),v(l,"aria-label","Contact me"),v(l,"class","svelte-m6xsfi"),v(B,"class","arrow-left svelte-m6xsfi"),v(B,"aria-label","Scroll left"),v(O,"class","arrow-right svelte-m6xsfi"),v(O,"aria-label","Scroll right"),v(r,"id","gradient"),v(r,"class","glass-pane svelte-m6xsfi")},m(c,x){D(c,r,x),V(s,r,null),m(r,f),m(r,t),V(e,t,null),m(t,i),V(n,t,null),m(t,_),V(u,t,null),m(t,b),V(g,t,null),m(t,$),V(h,t,null),d[4](t),m(r,L),m(r,w),m(r,a),m(r,l),m(l,p),m(l,o),m(r,z),m(r,B),m(r,Y),m(r,O),G=!0,Z||(tn=[j(l,"click",d[1]),j(B,"click",d[2]),j(O,"click",d[3])],Z=!0)},p:R,i(c){G||(H(s.$$.fragment,c),H(e.$$.fragment,c),H(n.$$.fragment,c),H(u.$$.fragment,c),H(g.$$.fragment,c),H(h.$$.fragment,c),G=!0)},o(c){I(s.$$.fragment,c),I(e.$$.fragment,c),I(n.$$.fragment,c),I(u.$$.fragment,c),I(g.$$.fragment,c),I(h.$$.fragment,c),G=!1},d(c){c&&A(r),N(s),N(e),N(n),N(u),N(g),N(h),d[4](null),Z=!1,sn(tn)}}}const K="lumi.main.mail@gmail.com";function bn(d,r,s){const f=o=>{navigator.clipboard.writeText(K);const y=o.currentTarget.children.item(0);y&&(y.classList.remove("hidden"),setTimeout(()=>{y.classList.add("hidden")},2e3))};let t,e=0,i;const n=async()=>{i!==null&&clearTimeout(i),await cn(),i=setTimeout(()=>{let o=Math.round(e/window.innerWidth)*window.innerWidth;e=e-o>0?o+window.innerWidth:e-o<0?o-window.innerWidth:e,t.scrollTo({left:e,behavior:"smooth"})},300)};function _(){t!==null&&(e=(Math.round(e/window.innerWidth)-1)*window.innerWidth,e<0&&(e=t.scrollWidth-window.innerWidth),t.scrollTo({left:e,behavior:"smooth"}))}function u(){t!==null&&(e=(Math.round(e/window.innerWidth)+1)*window.innerWidth,e>t.scrollWidth-window.innerWidth&&(e=0),t.scrollTo({left:e,behavior:"smooth"}))}const b=()=>{e=t.scrollLeft,n()},g=o=>{switch(o.key){case"ArrowLeft":_();break;case"ArrowRight":case" ":u();break}},$=o=>{o.deltaY>0?_():u()};let h=0;const L=()=>{e=Math.round(e/h)*window.innerWidth,t&&t.scrollTo({left:e,behavior:"auto"}),h=window.innerWidth};let w=0,F=0;const a=o=>{o.button===0&&(w=o.clientX,F=o.clientY)},l=o=>{if(o.button===0){const y=o.clientX-w,z=o.clientY-F;Math.abs(y)>Math.abs(z)&&(y>0?_():u())}};on(()=>{t&&t.addEventListener("scroll",b),window&&(h=window.innerWidth,window.addEventListener("keyup",g),window.addEventListener("resize",L),window.addEventListener("wheel",$),window.addEventListener("mousedown",a),window.addEventListener("mouseup",l))}),ln(()=>{t&&t.removeEventListener("scroll",b),typeof window<"u"&&(window.removeEventListener("keyup",g),window.removeEventListener("resize",L),window.removeEventListener("wheel",$),window.removeEventListener("mousedown",a),window.removeEventListener("mouseup",l))});function p(o){an[o?"unshift":"push"](()=>{t=o,s(0,t)})}return[t,f,_,u,p]}class Sn extends Q{constructor(r){super(),nn(this,r,bn,yn,J,{})}}export{Sn as component};
