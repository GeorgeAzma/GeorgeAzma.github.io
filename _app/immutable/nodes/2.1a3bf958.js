import{s as R,n as _,o as X,b as G}from"../chunks/scheduler.e108d1fd.js";import{S as P,i as D,g as A,s as w,h as S,y as T,c as z,j as I,f as m,k as f,a as h,r as M,m as O,u as H,n as Y,v as k,x as N,z as $,d as V,t as B,w as U}from"../chunks/index.7e6319f2.js";function j(l){let t,o=`<a href="https://shadertoy.com/user/Peace" target="_blank" class="svelte-1csrgh0"><img class="nav-icon svelte-1csrgh0" src="shadertoy.png" alt="Shadertoy Icon"/>
		...
		Github</a>`,a,s;return{c(){t=A("nav"),t.innerHTML=o,a=w(),s=A("div"),this.h()},l(n){t=S(n,"NAV",{id:!0,class:!0,"data-svelte-h":!0}),T(t)!=="svelte-3ueudz"&&(t.innerHTML=o),a=z(n),s=S(n,"DIV",{}),I(s).forEach(m),this.h()},h(){f(t,"id","navbar"),f(t,"class","svelte-1csrgh0")},m(n,i){h(n,t,i),h(n,a,i),h(n,s,i)},p:_,i:_,o:_,d(n){n&&(m(t),m(a),m(s))}}}class q extends P{constructor(t){super(),D(this,t,null,j,R,{})}}function W(l){let t;return{c(){t=A("canvas"),this.h()},l(o){t=S(o,"CANVAS",{id:!0,class:!0}),I(t).forEach(m),this.h()},h(){f(t,"id","background-shader"),f(t,"class","svelte-1yt0mdc")},m(o,a){h(o,t,a),l[3](t)},p:_,i:_,o:_,d(o){o&&m(t),l[3](null)}}}function J(l,t,o){let{frag:a=""}=t,{vert:s=""}=t,n,i,r,v=performance.now();const b=[-1,-1,1,-1,-1,1,1,1];let d;function y(){if(n&&(o(0,n.width=window.innerWidth,n),o(0,n.height=window.innerHeight,n),r&&i)){const e=r.getUniformLocation(i,"resolution");r.uniform2f(e,n.width,n.height),r.viewport(0,0,n.width,n.height)}}X(()=>{if(r=n.getContext("webgl2"),!r){console.error("WebGL is not supported in this browser.");return}return d=r.createBuffer(),r.bindBuffer(r.ARRAY_BUFFER,d),r.bufferData(r.ARRAY_BUFFER,new Float32Array(b),r.STATIC_DRAW),v=performance.now(),window.addEventListener("resize",y),u(s,a),()=>{window.removeEventListener("resize",y)}});function u(e,c){if(c||(c="precision mediump float;void main() {gl_FragColor=vec4(1);}"),e||(e="attribute vec4 a_position;void main() {gl_Position = a_position;}"),!r)return;const g=r.createShader(r.FRAGMENT_SHADER);if(!g){alert("Could not create fragment shader");return}if(r.shaderSource(g,c),r.compileShader(g),!r.getShaderParameter(g,r.COMPILE_STATUS)){const E=r.getShaderInfoLog(g);console.error("Fragment shader compilation error:",E)}const p=r.createShader(r.VERTEX_SHADER);if(!p){alert("Could not create vertex shader");return}if(r.shaderSource(p,e),r.compileShader(p),!r.getShaderParameter(p,r.COMPILE_STATUS)){const E=r.getShaderInfoLog(p);console.error("Vertex shader compilation error:",E)}if(i&&(r.deleteProgram(i),i=null),i=r.createProgram(),!i){alert("Could not create shader program");return}r.attachShader(i,g),r.attachShader(i,p),r.linkProgram(i),r.deleteShader(g),r.deleteShader(p),r.useProgram(i);const L=r.getAttribLocation(i,"a_position");r.enableVertexAttribArray(L),r.vertexAttribPointer(L,2,r.FLOAT,!1,0,0),y(),x()}function x(){if(!(n&&r&&i))return;r.clearColor(0,0,0,1),r.clear(r.COLOR_BUFFER_BIT),r.useProgram(i),r.bindBuffer(r.ARRAY_BUFFER,d),r.drawArrays(r.TRIANGLE_STRIP,0,4);const e=r.getUniformLocation(i,"time");e&&r.uniform1f(e,(performance.now()-v)/1e3),requestAnimationFrame(x)}function C(e){G[e?"unshift":"push"](()=>{n=e,o(0,n)})}return l.$$set=e=>{"frag"in e&&o(1,a=e.frag),"vert"in e&&o(2,s=e.vert)},l.$$.update=()=>{l.$$.dirty&6&&u(s,a)},[n,a,s,C]}class K extends P{constructor(t){super(),D(this,t,J,W,R,{frag:1,vert:2})}}const Q=`precision mediump float;\r
\r
...
}`;function Z(l){let t,o,a,s,n,i="I'm George Azmaipharashvili, Software engineer mainly specialized at graphics.",r,v,b,d,y="(Copied)",u,x,C;return t=new K({props:{frag:Q}}),a=new q({}),{c(){M(t.$$.fragment),o=w(),M(a.$$.fragment),s=w(),n=A("div"),n.textContent=i,r=w(),v=A("button"),b=O(F),d=A("span"),d.textContent=y,this.h()},l(e){H(t.$$.fragment,e),o=z(e),H(a.$$.fragment,e),s=z(e),n=S(e,"DIV",{class:!0,"data-svelte-h":!0}),T(n)!=="svelte-1yualih"&&(n.textContent=i),r=z(e),v=S(e,"BUTTON",{id:!0,class:!0});var c=I(v);b=Y(c,F),d=S(c,"SPAN",{class:!0,"data-svelte-h":!0}),T(d)!=="svelte-nvhv7g"&&(d.textContent=y),c.forEach(m),this.h()},h(){f(n,"class","main-text svelte-zj2if8"),f(d,"class","hidden svelte-zj2if8"),f(v,"id","contact-info"),f(v,"class","svelte-zj2if8")},m(e,c){k(t,e,c),h(e,o,c),k(a,e,c),h(e,s,c),h(e,n,c),h(e,r,c),h(e,v,c),N(v,b),N(v,d),u=!0,x||(C=$(v,"click",l[0]),x=!0)},p:_,i(e){u||(V(t.$$.fragment,e),V(a.$$.fragment,e),u=!0)},o(e){B(t.$$.fragment,e),B(a.$$.fragment,e),u=!1},d(e){e&&(m(o),m(s),m(n),m(r),m(v)),U(t,e),U(a,e),x=!1,C()}}}const F="lumi.main.mail@gmail.com";function rr(l){return[o=>{navigator.clipboard.writeText(F);const a=o.currentTarget.children.item(0);a&&(a.classList.remove("hidden"),setTimeout(()=>{a.classList.add("hidden")},2e3))}]}class nr extends P{constructor(t){super(),D(this,t,rr,Z,R,{})}}export{nr as component};
