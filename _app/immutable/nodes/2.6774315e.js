import{s as Q,n as V,o as ie,b as ae,r as le,f as ce}from"../chunks/scheduler.b108d059.js";import{S as ee,i as re,g as k,s as C,h as T,y as D,c as S,j as F,f as _,k as v,a as q,r as A,m as fe,u as P,n as ve,v as R,x as h,z as K,d as H,t as I,w as N}from"../chunks/index.f5626e03.js";function de(d){let s,l=`<a href="https://shadertoy.com/user/Peace" target="_blank" class="svelte-o61m3w"><img class="nav-icon svelte-o61m3w" src="shadertoy.webp" alt="Shadertoy Icon" width="38" height="38"/>
		...
		LinkedIn</a>`,i,n;return{c(){s=k("nav"),s.innerHTML=l,i=C(),n=k("div"),this.h()},l(t){s=T(t,"NAV",{id:!0,class:!0,"data-svelte-h":!0}),D(s)!=="svelte-w5m299"&&(s.innerHTML=l),i=S(t),n=T(t,"DIV",{}),F(n).forEach(_),this.h()},h(){v(s,"id","navbar"),v(s,"class","svelte-o61m3w")},m(t,r){q(t,s,r),q(t,i,r),q(t,n,r)},p:V,i:V,o:V,d(t){t&&(_(s),_(i),_(n))}}}class ue extends ee{constructor(s){super(),re(this,s,null,de,Q,{})}}function me(d){let s;return{c(){s=k("canvas"),this.h()},l(l){s=T(l,"CANVAS",{id:!0,class:!0}),F(s).forEach(_),this.h()},h(){v(s,"id","background-shader"),v(s,"class","svelte-9zun04")},m(l,i){q(l,s,i),d[3](s)},p:V,i:V,o:V,d(l){l&&_(s),d[3](null)}}}function he(d,s,l){let{frag:i=""}=s,{vert:n=""}=s,t,r=null,e=null,w,u,O=null,x=null;function M(){const a=t.getBoundingClientRect();return a.left>-window.innerWidth&&a.right<window.innerWidth*2}function y(){const a=t.getBoundingClientRect();return a.left>=-window.innerWidth&&a.right<=window.innerWidth*2}function z(){const a=window.devicePixelRatio||1;l(0,t.width=window.innerWidth*a,t),l(0,t.height=window.innerHeight*a,t),l(0,t.style.width=`${window.innerWidth}px`,t),l(0,t.style.height=`${window.innerHeight}px`,t),e&&r&&(e.useProgram(r),e.uniform2f(O,t.width,t.height),e.viewport(0,0,t.width,t.height))}ie(()=>{if(e=t.getContext("webgl2"),!e){console.error("WebGL is not supported in this browser.");return}return w=performance.now(),u=w,window.addEventListener("resize",z),g(n,i),()=>{window.removeEventListener("resize",z)}});function g(a,L){if(L||(L=`#version 300 es 
      out vec4 fragColor;
      void main() {
      ...
      }`),!!e){if(y()){const o=e.createShader(e.FRAGMENT_SHADER);if(!o){alert("Could not create fragment shader");return}if(e.shaderSource(o,L),e.compileShader(o),!e.getShaderParameter(o,e.COMPILE_STATUS)){const p=e.getShaderInfoLog(o);console.error("Fragment shader compilation error:",p)}const f=e.createShader(e.VERTEX_SHADER);if(!f){alert("Could not create vertex shader");return}if(e.shaderSource(f,a),e.compileShader(f),!e.getShaderParameter(f,e.COMPILE_STATUS)){const p=e.getShaderInfoLog(f);console.error("Vertex shader compilation error:",p)}if(r&&(e.deleteProgram(r),r=null),r=e.createProgram(),!r){alert("Could not create shader program");return}if(e.attachShader(r,o),e.attachShader(r,f),e.linkProgram(r),!e.getProgramParameter(r,e.LINK_STATUS)){const p=e.getProgramInfoLog(r);console.error("Program link error:",p)}e.deleteShader(o),e.deleteShader(f),e.useProgram(r),O=e.getUniformLocation(r,"resolution"),x=e.getUniformLocation(r,"time")}z(),E()}}function E(){if(!(t&&e))return;let a=performance.now();if(!M()){requestAnimationFrame(E);const L=a-u;w+=L,u=a;return}r||g(n,i),r&&(e.clearColor(0,0,0,1),e.clear(e.COLOR_BUFFER_BIT),e.useProgram(r),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.uniform1f(x,(a-w)/1e3),u=a,requestAnimationFrame(E))}function b(a){ae[a?"unshift":"push"](()=>{t=a,l(0,t)})}return d.$$set=a=>{"frag"in a&&l(1,i=a.frag),"vert"in a&&l(2,n=a.vert)},d.$$.update=()=>{d.$$.dirty&6&&g(n,i)},[t,i,n,b]}class U extends ee{constructor(s){super(),re(this,s,he,me,Q,{frag:1,vert:2})}}const pe=`#version 300 es\r
\r
...
\r
    fragColor = vec4(col, 1);\r
}`;function _e(d){let s,l,i,n,t,r,e,w,u,O,x,M,y,z,g,E,b,a="I'm Lumiey, graphics developer and software engineer.",L,o,f,p,ne="(Copied)",Z,W,te='<svg viewBox="-4.5 0 20 20" stroke="#ffffffcc" stroke-width="0.6" fill="#ffffffaa" class="svelte-f552qf"><path transform="translate(-331.000000, -6519.000000)" d="M338.61,6539 L340,6537.594 L331.739,6528.987 L332.62,6528.069 L332.615,6528.074 L339.955,6520.427 L338.586,6519 C336.557,6521.113 330.893,6527.014 329,6528.987 C330.406,6530.453 329.035,6529.024 338.61,6539" class="svelte-f552qf"></path></svg>',X,B,oe='<svg viewBox="-4.5 0 20 20" stroke="#ffffffcc" stroke-width="0.6" fill="#ffffffaa" class="svelte-f552qf"><path transform="scale(-1, 1) translate(-341.000000, -6519.000000)" d="M338.61,6539 L340,6537.594 L331.739,6528.987 L332.62,6528.069 L332.615,6528.074 L339.955,6520.427 L338.586,6519 C336.557,6521.113 330.893,6527.014 329,6528.987 C330.406,6530.453 329.035,6529.024 338.61,6539" class="svelte-f552qf"></path></svg>',G,Y,se;return n=new ue({}),e=new U({props:{frag:pe}}),u=new U({props:{frag:ge}}),x=new U({props:{frag:we}}),y=new U({props:{frag:xe}}),g=new U({props:{frag:ye}}),{c(){s=k("div"),l=C(),i=k("div"),A(n.$$.fragment),t=C(),r=k("div"),A(e.$$.fragment),w=C(),A(u.$$.fragment),O=C(),A(x.$$.fragment),M=C(),A(y.$$.fragment),z=C(),A(g.$$.fragment),E=C(),b=k("h1"),b.textContent=a,L=C(),o=k("button"),f=fe(J),p=k("span"),p.textContent=ne,Z=C(),W=k("button"),W.innerHTML=te,X=C(),B=k("button"),B.innerHTML=oe,this.h()},l(c){s=T(c,"DIV",{class:!0}),F(s).forEach(_),l=S(c),i=T(c,"DIV",{id:!0,class:!0});var m=F(i);P(n.$$.fragment,m),t=S(m),r=T(m,"DIV",{id:!0,class:!0});var $=F(r);P(e.$$.fragment,$),w=S($),P(u.$$.fragment,$),O=S($),P(x.$$.fragment,$),M=S($),P(y.$$.fragment,$),z=S($),P(g.$$.fragment,$),$.forEach(_),E=S(m),b=T(m,"H1",{class:!0,"data-svelte-h":!0}),D(b)!=="svelte-12vckjm"&&(b.textContent=a),L=S(m),o=T(m,"BUTTON",{id:!0,"aria-label":!0,class:!0});var j=F(o);f=ve(j,J),p=T(j,"SPAN",{class:!0,"data-svelte-h":!0}),D(p)!=="svelte-nvhv7g"&&(p.textContent=ne),j.forEach(_),Z=S(m),W=T(m,"BUTTON",{class:!0,"aria-label":!0,"data-svelte-h":!0}),D(W)!=="svelte-1eth16w"&&(W.innerHTML=te),X=S(m),B=T(m,"BUTTON",{class:!0,"aria-label":!0,"data-svelte-h":!0}),D(B)!=="svelte-3l2q6y"&&(B.innerHTML=oe),m.forEach(_),this.h()},h(){v(s,"class","loader svelte-f552qf"),v(r,"id","shaders"),v(r,"class","svelte-f552qf"),v(b,"class","main-text svelte-f552qf"),v(p,"class","hidden svelte-f552qf"),v(o,"id","contact-info"),v(o,"aria-label","Contact me"),v(o,"class","svelte-f552qf"),v(W,"class","arrow-left svelte-f552qf"),v(W,"aria-label","Scroll left"),v(B,"class","arrow-right svelte-f552qf"),v(B,"aria-label","Scroll right"),v(i,"id","gradient"),v(i,"class","glass-pane svelte-f552qf")},m(c,m){q(c,s,m),q(c,l,m),q(c,i,m),R(n,i,null),h(i,t),h(i,r),R(e,r,null),h(r,w),R(u,r,null),h(r,O),R(x,r,null),h(r,M),R(y,r,null),h(r,z),R(g,r,null),d[4](r),h(i,E),h(i,b),h(i,L),h(i,o),h(o,f),h(o,p),h(i,Z),h(i,W),h(i,X),h(i,B),G=!0,Y||(se=[K(o,"click",d[1]),K(W,"click",d[2]),K(B,"click",d[3])],Y=!0)},p:V,i(c){G||(H(n.$$.fragment,c),H(e.$$.fragment,c),H(u.$$.fragment,c),H(x.$$.fragment,c),H(y.$$.fragment,c),H(g.$$.fragment,c),G=!0)},o(c){I(n.$$.fragment,c),I(e.$$.fragment,c),I(u.$$.fragment,c),I(x.$$.fragment,c),I(y.$$.fragment,c),I(g.$$.fragment,c),G=!1},d(c){c&&(_(s),_(l),_(i)),N(n),N(e),N(u),N(x),N(y),N(g),d[4](null),Y=!1,le(se)}}}const J="lumi.main.mail@gmail.com";function be(d,s,l){const i=o=>{navigator.clipboard.writeText(J);const f=o.currentTarget.children.item(0);f&&(f.classList.remove("hidden"),setTimeout(()=>{f.classList.add("hidden")},2e3))};let n,t=null,r=0;const e=async()=>{t!==null&&(clearTimeout(t),t=null),t=setTimeout(()=>{r=Math.round(n.scrollLeft/window.innerWidth),n.scrollTo({left:r*window.innerWidth,behavior:"smooth"})},500)};function w(){n!==null&&(r-=1,r<0&&(r=n.scrollWidth/window.innerWidth-1),n.scrollTo({left:r*window.innerWidth,behavior:"smooth"}))}function u(){n!==null&&(r+=1,r>n.scrollWidth/window.innerWidth-1&&(r=0),n.scrollTo({left:r*window.innerWidth,behavior:"smooth"}))}const O=()=>{e()},x=o=>{switch(o.key){case"ArrowLeft":case"a":w();break;case"ArrowRight":case"d":case" ":u();break}},M=o=>{o.deltaY>0?w():u()};let y=0;const z=()=>{let o=Math.round(n.scrollLeft/y)*window.innerWidth;n&&n.scrollTo({left:o,behavior:"instant"}),y=window.innerWidth};let g=0,E=0;const b=o=>{o.button===0&&(g=o.clientX,E=o.clientY)},a=o=>{if(o.button===0){const f=o.clientX-g,p=o.clientY-E;Math.abs(f)>Math.abs(p)&&(f>0?w():u())}};ie(()=>{n&&n.addEventListener("scroll",O),window&&(y=window.innerWidth,window.addEventListener("keyup",x),window.addEventListener("resize",z),window.addEventListener("wheel",M),window.addEventListener("mousedown",b),window.addEventListener("mouseup",a))}),ce(()=>{n&&n.removeEventListener("scroll",O),typeof window<"u"&&(window.removeEventListener("keyup",x),window.removeEventListener("resize",z),window.removeEventListener("wheel",M),window.removeEventListener("mousedown",b),window.removeEventListener("mouseup",a))});function L(o){ae[o?"unshift":"push"](()=>{n=o,l(0,n)})}return[n,i,w,u,L]}class Se extends ee{constructor(s){super(),re(this,s,be,_e,Q,{})}}export{Se as component};
